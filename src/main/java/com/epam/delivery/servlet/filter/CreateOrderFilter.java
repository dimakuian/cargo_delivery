...
@WebFilter("/create_order")
public class CreateOrderFilter implements Filter {
    /**
    ...
    public void init(FilterConfig filterConfig) {
        System.out.println("CreateOrderFilter init");
    }
    ...
    @Override
    public void destroy() {
        System.out.println("CreateOrderFilter destroy...");
    }
}
