...
public final class SqlQuery {
    ...
    public static final String SQL_QUERY__INVOICE_UPDATE = "UPDATE `delivery`.`invoice` SET client_id =?, creation_datetime=?, " +
            "order_id=?, sum=?, invoice_status_id=? WHERE id=?";
    ...
    public static final String SQL_QUERY__INVOICE_SELECT_CLIENT_INVOICES_BY_ID = "SELECT id, client_id, " +
            "creation_datetime, order_id, sum, invoice_status_id FROM `delivery`.`invoice` WHERE id=?";
