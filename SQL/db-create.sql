...
VALUES (1, 1, 'Kiev', 'T.Shevchenko', '12'),
       (1, 2, 'Київ', 'Т.Шевченка', '12'),
       (2, 1, 'Lviv', 'V. Stusa', '1'),
       (2, 2, 'Львів', 'В. Стуса', '1'),
       (3, 1, 'Odesa', 'S. Tomashivsky', '10'),
       (3, 2, 'Одеса', 'С. Томашівського', '10'),
       (4, 1, 'Ternopil', 'S. Tomashivsky', '30'),
       (4, 2, 'Тернопіль', 'С. Томашівського', '30'),
       (5, 1, 'Rivne', 'T.Shevchenko', '81'),
       (5, 2, 'Рівне', 'Т.Шевченка', '81'),
       (6, 1, 'Lutsk', 'V. Chornovola', '5'),
       (6, 2, 'Луцьк', 'В. Чорновола', '5'),
       (7, 1, 'Kovel', 'S. Banderi', '14'),
       (7, 2, 'Ковель', 'С. Бандери', '14'),
       (8, 1, 'Chernivtsi', 'T.Shevchenko', '133'),
       (8, 2, 'Чернівці', 'Т.Шевченка', '133'),
       (9, 1, 'Khmelnytskyi', 'B. Khmelnytsky', '22'),
       (9, 2, 'Хмельницький', 'Б. Хмельницького', '22'),
       (10, 1, 'Vinnytsia', 'V. Stusa', '2'),
       (10, 2, 'Вінниця', 'В. Стуса', '2'),
       (11, 1, 'Zhytomyr', 'V. Chornovola', '32'),
       (11, 2, 'Житомир', 'В. Чорновола', '32'),
       (12, 1, 'Dnipro', 'T.Shevchenko', '2'),
       (12, 2, 'Дніпро', 'Т.Шевченка', '2'),
       (13, 1, 'Zaporizhzhya', 'V. Simonenko', '0'),
       (13, 2, 'Запоріжжя', 'В. Симоненка', '3'),
       (14, 1, 'Mykolaiv', 'S. Tomashivsky', '66'),
       (14, 2, 'Миколаїв', 'С. Томашівського', '66'),
       (15, 1, 'Ivano-Frankivsk', 'V. Simonenko', '0'),
       (15, 2, 'Івано-Франківськ', 'В. Симоненка', '4'),
       (16, 1, 'Mukachevo', 'T.Shevchenko', '38'),
       (16, 2, 'Мукачево', 'Т.Шевченка', '38');
